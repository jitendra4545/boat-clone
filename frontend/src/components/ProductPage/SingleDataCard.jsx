...
<Box display={'grid'} gridTemplateColumns={{ base: "repeat(1,1fr)", md: "repeat(2,1fr)", lg: "repeat(2,1fr)" }} gap='2' w={{ base: "97%", md: "95%", lg: "90%" }} margin={'auto'}>
            <Box display={'flex'} w='95%'   >
                ...
                <Box bg="green.100" borderRadius={'15px'} display={'flex'} justifyContent={'center '} alignItems={'center'} ml='30px'  >
                    <Box>
                        {
            ...
            <Box w={{base:"90%",md:"100%",lg:"100%"}} m='auto' >
                <Box>
                    ...
                    <Box p='10px 0px ' >
                        ...
                        <Button bg='black' color='white' mt='5px' borderRadius={'20px'}  w={{ base: "100%", md: "80%", lg: "60%" }}><BsHandbagFill /> <span style={{marginLeft:'10px'}}>ADD TO CART</span></Button>
                    </Box>
                </Box>
