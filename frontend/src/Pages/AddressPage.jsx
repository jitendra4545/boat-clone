import { Box, Button, Drawer, DrawerBody, DrawerCloseButton, DrawerContent, DrawerFooter, DrawerHeader, DrawerOverlay, Flex, FormControl, FormLabel, Grid, GridItem, Heading, Image, Input, Select, Table, TableContainer, Tbody, Text, Th, Thead, Tr, border, useDisclosure, useToast } from '@chakra-ui/react'
  ...
  <Table  variant='simple'>
    ...
    <Thead>
      <Tr>
        ...
        <Th fontSize={'15px'} color={'black'}>Address</Th>
        <Th fontSize={'15px'} color={'black'}>Pincode</Th>
        <Th fontSize={'15px'} color={'black'}>Mobile</Th>
        <Th fontSize={'15px'} color={'black'}>Remove</Th>
      </Tr>
    </Thead>
    <Tbody>
    {
...
<>
            ...
            <Button ref={btnRef} mt={'20px'} onClick={onOpen} color='red'> + ADD NEW ADDRESS</Button>
